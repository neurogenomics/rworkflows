...
*NOTE*: A fully functionalized version of this script is available 
via the R package [`echogithub`](https://github.com/RajLabMSSM/echogithub):
`echogithub::r_repos()`
