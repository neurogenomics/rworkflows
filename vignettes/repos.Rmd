...
```R
r_repos_res <- echogithub::r_repos(save_path = here::here("reports","r_repos.pdf"))
```

[!Upset plot](https://github.com/neurogenomics/rworkflows/raw/master/reports/r_repos.pdf)
